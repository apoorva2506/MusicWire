...
$query = $connection -> prepare("SELECT distinct tid,ttitle,aname from plays,track,artist where plays.trackid = track.tid and track.aid=artist.aid and uid=? order by playsTS desc limit 10");
