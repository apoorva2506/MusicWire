...
$query = $connection -> prepare("SELECT distinct pid, pTitle from playlist where uid=?");
		...
		<div class="container">
				...
				<div class="comments-top-top">
					<div class="top-comment-left">
						...
						<?php 
							if ($rows >= 1) {
 							$query->bind_result($pid, $pname);
							while ($query->fetch()) { ?>
					<div class="top-comment-right">
						<div class="right-comment">
							<h5> <a href="playlistinfo.php?id=<?php echo $pid; ?>"> <?php echo $pname; ?></a></h5>
							<div class="clearfix"> </div>
						</div>
					</div>
						<?php   } ?>
