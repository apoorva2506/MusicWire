...
$query = $connection -> prepare("SELECT tid,ttitle,aname from ((SELECT trackid, sum(rating) cnt FROM rating group by trackid order by cnt desc limit 10) a join track on a.trackid=track.tid) natural join artist");
