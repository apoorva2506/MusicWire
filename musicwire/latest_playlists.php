...
$query = $connection -> prepare("SELECT distinct pid, ptitle from playlist natural join playlist_track where uid in (select uid2 from follows where uid1=?) and pLabel='public' order by pDate desc limit 10");
$query->bind_param('i', $_SESSION['login_id']);
$query->execute();
$query->store_result();
$rows = $query->num_rows;
...
<!--content-->
	<div class="blog">
		<div class="container">
					...
					<div class="lone-line">
						<h4>Latest Playlists by Followed Users</h4>
				...
				<div class="comments-top-top">
					<div class="top-comment-left">
						...
						<?php 
							if ($rows >= 1) {
 							$query->bind_result($albumid, $album);
							while ($query->fetch()) { ?>
					<div class="top-comment-right">
						<div class="right-comment">
							<h5> <a href="playlistinfo.php?id=<?php echo $albumid; ?>"> <?php echo $album; ?></a></h5>
							<div class="clearfix"> </div>
						</div>
