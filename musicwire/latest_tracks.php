...
$query = $connection -> prepare("SELECT distinct tid,ttitle,aname from artist natural join track natural join album where aid in (select aid from likes where uid=?) order by albumDate desc limit 10");
...
<!--content-->
	<div class="blog">
		<div class="container">
					...
					<div class="lone-line">
						<h4>Latest Tracks by Liked Artists</h4>
