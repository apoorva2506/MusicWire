...
$query = $connection -> prepare("SELECT distinct albumid, albumTitle from artist natural join track natural join album where aid in (select aid from likes where uid=?) order by albumDate desc limit 10");
...
<!--content-->
	<div class="blog">
		<div class="container">
					...
					<div class="lone-line">
						<h4>Latest Albums by Liked Artists</h4>
				...
				<div class="comments-top-top">
					...
					<div class="top-comment-right">
						<div class="right-comment">
							<h5> <a href="albuminfo.php?id=<?php echo $albumid; ?>"> <?php echo $album; ?></a></h5>
							<div class="clearfix"> </div>
						</div>
					</div>
						<?php   } ?>
